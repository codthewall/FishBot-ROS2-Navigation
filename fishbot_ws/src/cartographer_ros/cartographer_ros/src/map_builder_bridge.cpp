...
void MapBuilderBridge::UpdateTrajectoryPose(
    const int trajectory_id, const cartographer::transform::Rigid3d& pose) {
  map_builder_->UpdateTrajectoryPose(trajectory_id, pose);
}
